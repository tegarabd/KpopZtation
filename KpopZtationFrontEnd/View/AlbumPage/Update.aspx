<%@ Page Title="" Language="C#" MasterPageFile="~/View/NavBar.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="KpopZtationFrontEnd.View.AlbumPage.Update" %>
        ...
        <asp:Table ID="Table" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2">
                    <div class="card">
                        <asp:Image ID="ImageAlbum" runat="server" />
                    </div>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
